...
void BHTree::insert(Body* b) {
    ...
    if (!body && !NW) {
        ...
        if (NW->region.contains(*b)) NW->insert(b);
        else if (NE->region.contains(*b)) NE->insert(b);
        else if (SW->region.contains(*b)) SW->insert(b);
        else if (SE->region.contains(*b)) SE->insert(b);
